...
class BestDealStack(Stack):
    ...
    def create_lambda_layer(self):
        lambda_layer = _lambda.LayerVersion(
            self,
            "GenerativeAIBestDealLambdaLayer",
    ...
    def create_lambda(self, lambda_layer):
        lambda_func = _lambda.Function(
            self,
            "GenerativeAIBestDealLambdaFunc",
            function_name="generative-ai-best-deal",
            runtime=_lambda.Runtime.PYTHON_3_12,
            memory_size=1000,
            code=_lambda.Code.from_asset("lambda"),
            handler="best_deal.handler",
    ...
    def create_api_gateway(self, lambda_func):
        api_gateway = _apigateway.LambdaRestApi(
            self,
            "GenerativeAIBestDealApiGateway",
            handler=lambda_func,
        ...
        best_deal = api.add_resource("best-deal")
        best_deal.add_method("GET")  # GET /generative-ai/best-deal
